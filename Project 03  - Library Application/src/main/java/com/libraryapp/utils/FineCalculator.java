...
public class FineCalculator {
	...
	/**
	 * Returns a map of all users with the amount of fines in $ currency.
	 * @param users list of all current users stored in the database.
	 * @return LinkedHashMap which holds users as key and fine as value.
	 */
	 ...
	 * @param books list of all current books stored in the database.
	 * @return LinkedHashMap of all books as key with the amount of fines in $ currency.
	 */
	...
	*/
	...
	/**
	*Checks if a user has a fine or not.
	*@param User an user stored in the database
