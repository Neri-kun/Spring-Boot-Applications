...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user11 = new User("batman124", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Bruce", "Wayne", "Itersonstraat 195", "06-98374821", "Assen");
			User user12 = new User("spiderman124", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Peter", "Parker", "Itersonstraat 195", "06-98374821", "Assen");
			User user13 = new User("ironman124", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Tony", "Stark", "Itersonstraat 195", "06-98374821", "Assen");
			User user14 = new User("japan125", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Tsuyoshi", "Tokunaga", "Itersonstraat 195", "06-98374821", "Assen");
			User user15 = new User("japan126", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Issei", "Hyoudou", "Itersonstraat 195", "06-98374821", "Assen");
			User user16 = new User("japan127", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Issei", "Hyoudou", "Itersonstraat 195", "06-98374821", "Assen");
			User user22 = new User("japan132", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Issei", "Hyoudou", "Itersonstraat 195", "06-98374821", "Assen");
			//User user15 = new User("japan126", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Issei", "Hyoudou", "Itersonstraat 195", "06-98374821", "Assen");
			user14.setRole("ROLE_USER");
			user15.setRole("ROLE_USER");
			user16.setRole("ROLE_USER");
			user22.setRole("ROLE_USER");
			...
			book2.setTheUser(user22);
			book2.setReturnDate(LocalDate.of(2021,9,10));
			
			book3.setTheUser(user22);
			book3.setReturnDate(LocalDate.of(2021,9,10));
			
			book4.setTheUser(user22);
			book4.setReturnDate(LocalDate.of(2021,9,26));
			
			user22.setBooks(Arrays.asList(book2, book3,book4));
